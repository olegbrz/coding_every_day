...
Could you make a program that makes this string uppercase, gives it sorted in
...
def meeting(s): return ''.join(sorted(
    [f'({p.split(":")[1].upper()}, {p.split(":")[0].upper()})'for p in s.split(';')]))
